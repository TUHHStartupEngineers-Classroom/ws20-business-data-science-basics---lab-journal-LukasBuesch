...
# Intro to the tidyverse - first challenge
In the following you will find my R Code and the corresponding plots.
...
# First tries
These are my first changes in the **Journal** 'markdown' File 
