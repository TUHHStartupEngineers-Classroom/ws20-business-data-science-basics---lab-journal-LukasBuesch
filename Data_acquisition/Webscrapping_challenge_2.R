...
saveRDS(bike_data_tbl, "Data_acquisition/bike_data_tbl.rds")
...
saveRDS(bike_data_cleaned_tbl, "Data_acquisition/bike_data_cleaned_tbl.rds")
...
saveRDS(bike_data_colors_tbl, "Data_acquisition/bike_data_colors_tbl.rds")
...
saveRDS(bike_data_sizes_tbl, "Data_acquisition/bike_data_sizes_tbl.rds")
